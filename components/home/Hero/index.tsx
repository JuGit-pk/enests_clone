...
const Hero = () => {
  const categories = [
    { title: "marketing", children: <FaBullhorn size="1.7rem" /> },
  ...
  return (
    <Container className="text-center pt-7 pb-1 lg:py-20">
      ...
      <div className="w-full bg-white/40 rounded-md my-4 p-4 text-black space-x-0 space-y-1 md:space-y-0 md:space-x-4 flex justify-center items-center flex-col md:flex-row">
        <input
          type="text"
        ...
        <button className="w-full md:max-w-[184px] justify-center uppercase bg-primary border border-white py-3 px-10 flex items-center text-white font-raleway text-lg rounded-md">
          <span>
            <svg
